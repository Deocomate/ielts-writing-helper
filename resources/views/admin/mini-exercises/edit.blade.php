<x-admin.layout.app title="Sửa bài tập" active="mini-exercises">
	<div class="mb-4 flex items-center gap-2 text-sm">
		...
		<span class="text-text-primary font-medium truncate max-w-xs">{{ $exercise->title }}</span>
	</div>
	...
	<div class="max-w-4xl bg-white border border-border-light rounded-xl p-5 sm:p-6 shadow-card">
		@include('admin.mini-exercises.partials.form', [
			'action' => route('admin.mini-exercises.update', $exercise),
			'method' => 'PUT',
			'exercise' => $exercise,
		])
	</div>
